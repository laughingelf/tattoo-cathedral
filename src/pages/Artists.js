...
function Artists() {
    return (
        <div id="artist" className="page-data flex flex-col items-center justify-center text-xl ">
            <h1 className="border-b border-black">Artists</h1>

            <div id="artist-card" className="h-2/3 m-5">
                <div id="social-links" className="flex flex-wrap justify-center items-center px-4 py-6 sm:flex-row sm:justify-evenly sm:items-center text-xl">
